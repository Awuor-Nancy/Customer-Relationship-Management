...
customerByName = Customer.objects.get(name='Elly Wenani')
...
productsFiltered = Product.objects.filter(tags__name="kitchen")
...
ballOrders = firstCustomer.order_set.filter(product__name="dishes").count()
